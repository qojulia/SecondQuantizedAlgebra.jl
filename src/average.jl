...
SymbolicUtils.Add(::Type{AvgSym}, coeff, dict; kw...) = SymbolicUtils.Add(CNumber, coeff, dict, kw...)
SymbolicUtils.Mul(::Type{AvgSym}, coeff, dict; kw...) = SymbolicUtils.Mul(CNumber, coeff, dict, kw...)
