...
fig2 = plot(; size = (470, 410), xlabel = "Re α₂", ylabel = "Im α₂", aspect_ratio = :equal, title = "Wigner samples, site 2 (t = 200)", margin = 5Plots.mm)
heatmap!(fig2, bincenters(hist)..., bincounts(hist); color = :magma, label = false)
